...
import com.bintonet.gnatter.custom.CustomActivity;
import com.bintonet.gnatter.model.Conversation;
import com.bintonet.gnatter.utils.Const;
...
public class Chat extends CustomActivity
{
    ...
    private void sendMessage()
    {
        ...
        final Conversation c = new Conversation(s, (java.sql.Date) new Date(),
                ...
                if (li != null && li.size() > 0)
                {
                    for (int i = li.size() - 1; i >= 0; i--)
                    {
                        ...
                        Conversation c = new Conversation(po
                                .getString("message"), (java.sql.Date) po.getCreatedAt(), po
                                .getString("sender"));
                        convList.add(c);
                        if (lastMsgDate == null
